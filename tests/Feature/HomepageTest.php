...
class HomepageTest extends TestCase
{
    ...
    public function test_homepage_is_rendered(): void
    {
        ...
        $response
            ...
            ->assertSeeText('Students, instructors, cohorts, assessments, attendance cases, and interventions are modeled as domain concepts, not generic records')
            ...
            ->assertSeeText('Approvals, asset delivery, and feedback states are obvious at a glance instead of hiding behind ornamental layouts')
