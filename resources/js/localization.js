...
const ptBR = {
    ...
    'Close Djinn conversation': 'Fechar conversa com Djinn',
    Conversation: 'Conversa',
    'Your question for Djinn': 'Sua pergunta para Djinn',
    'Ask Djinn…': 'Pergunte ao Djinn…',
    'Send question': 'Enviar pergunta',
    'Type a question for Djinn.': 'Digite uma pergunta para Djinn.',
    'English / Português brasileiro. Djinn does not save your conversation. AI providers process your messages and audio.': 'Inglês / Português brasileiro. Djinn não salva sua conversa. Provedores de IA processam suas mensagens e seu áudio.',
    'Djinn is helping other visitors. Please try again shortly.': 'Djinn está atendendo outros visitantes. Tente novamente em instantes.',
    'Djinn is outside its availability hours. Please try again later.': 'Djinn está fora do horário de disponibilidade. Tente novamente mais tarde.',
    'Djinn has reached its session limit for today. Please try another day.': 'Djinn atingiu o limite de sessões de hoje. Tente em outro dia.',
    'Too many connection attempts. Please wait up to an hour before trying again.': 'Muitas tentativas de conexão. Aguarde até uma hora antes de tentar novamente.',
    'Please wait a moment, then try again.': 'Aguarde um momento e tente novamente.',
    'Session ended. Ask Djinn to start again.': 'Sessão encerrada. Pergunte ao Djinn para recomeçar.',
    'Allow microphone access to talk to Djinn.': 'Permita o acesso ao microfone para falar com Djinn.',
    'Microphone access requires HTTPS. Open the secure version of this site, or use keyboard mode.': 'O microfone requer HTTPS. Abra a versão segura deste site ou use o teclado.',
    'This browser does not support microphone capture. Please use keyboard mode.': 'Este navegador não permite captura de áudio. Use o teclado.',
    'Microphone permission is blocked. Allow it in your browser’s site settings, then try again.': 'O acesso ao microfone está bloqueado. Permita-o nas configurações do site no navegador e tente novamente.',
    'No microphone was found. Connect an input device, or use keyboard mode.': 'Nenhum microfone foi encontrado. Conecte um dispositivo de entrada ou use o teclado.',
    'The microphone could not be opened. Check your device or other apps using it, then try again.': 'Não foi possível abrir o microfone. Verifique o dispositivo e outros aplicativos que o utilizam e tente novamente.',
    'Microphone capture was interrupted. Please try again.': 'A captura do microfone foi interrompida. Tente novamente.',
    'This microphone does not support the requested audio settings. Try another input device.': 'Este microfone não suporta as configurações de áudio solicitadas. Tente outro dispositivo de entrada.',
    'Microphone capture is disabled by browser policy. Please use keyboard mode.': 'A captura do microfone está desativada pela política do navegador. Use o teclado.',
    'The microphone could not be started. Please try again or use keyboard mode.': 'Não foi possível iniciar o microfone. Tente novamente ou use o teclado.',
    'Djinn is offline or unavailable. Please try again later.': 'Djinn está offline ou indisponível. Tente novamente mais tarde.',
    'Audio is unavailable in this browser.': 'Áudio indisponível neste navegador.',
    ...
    'Ask about this portfolio, or how Djinn retrieves approved context before it answers.': 'Pergunte sobre este portfólio ou como Djinn recupera contexto aprovado antes de responder.',
    'Djinn does not store this conversation or your audio.': 'Djinn não armazena esta conversa nem seu áudio.',
    ...
    'Djinn answered, but your browser could not play the audio.': 'Djinn respondeu, mas seu navegador não conseguiu reproduzir o áudio.',
    'Djinn needs a moment. Please try again.': 'Djinn precisa de um momento. Tente novamente.',
    'Grounded by': 'Contexto recuperado de',
    ...
    'Agentic Engineering': 'Engenharia com agentes',
    'I am studying how focused prompts, scoped agent loops, and independent verification make AI-assisted product work inspectable rather than noisy.': 'Estou estudando como ciclos de agentes, delegação bem delimitada e fluxos guiados por critérios de aceite mantêm o trabalho de produto com IA inspecionável ao invés de "ruidoso" (baixa legibilidade).',
    Theory: 'Teoria',
    'Optimizing RAG retrieval: Test, tune, succeed': 'Otimizando a recuperação RAG: teste, ajuste, avance',
    Repository: 'Repositório',
    'Capability demonstrations': 'Demonstrações de capacidade',
    'Here’s How I Shape Products': 'Como Estruturo Produtos',
    'Pricing / Finance': 'Pricing / Finanças',
    ...
    'Learning Operations': 'Operações Educacionais',
    ...
    'Creative Studio Portal': 'Portal de Estúdio Criativo',
    ...
    Yesterday: 'Ontem',
    'A portal built for': 'Um portal feito pro',
    'the work you care about': 'trabalho que importa',
    'for you': 'pra você',
